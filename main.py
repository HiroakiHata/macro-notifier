...
events = [
  {"title": "Prelim GDP q/q", "country": "JPY", "date": now.isoformat(), "impact": "High"},
  {"title": "Housing Starts", "country": "USD", "date": now.isoformat(), "impact": "Medium"},
  {"title": "BusinessNZ Manufacturing Index", "country": "NZD", "date": now.isoformat(), "impact": "Low"}
]
...
# --- GPT要約の文章テンプレ（簡易） ---
events_text = "\n".join([e['title'] for e in filtered])
